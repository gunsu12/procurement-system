                            ...
                            <div class="col-md-6">
                                <p class="mb-2"><strong>Total Pengajuan:</strong>
                                    <span class="badge badge-success" style="font-size: 1.1em;">
                                        Rp {{ number_format($procurement->items->sum('estimated_price'), 2, ',', '.') }}
                                    </span>
                                </p>
                            </div>
                        </div>
                                    ...
                                    @foreach ($procurement->items as $item)
                                        <tr>
                                            ...
                                            <td class="text-right">Rp
                                                {{ number_format($item->estimated_price, 2, ',', '.') }}</td>
                                            <td>{{ $item->unit }}</td>
                                ...
                                <tfoot class="table-info">
                                    <tr>
                                        ...
                                        <td class="text-right"><strong>Rp
                                                {{ number_format($procurement->items->sum('estimated_price'), 2, ',', '.') }}</strong>
                                        </td>
                                        <td colspan="2"></td>
                                    </tr>
                                </tfoot>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="documentModalLabel">Supporting Document:
                            {{ basename($procurement->document_path) }}</h5>
                    ...
                    <div class="modal-body" style="height: 80vh; overflow-y: auto;">
                        ...
                        @if ($isImage)
                            <div class="text-center">
                                <img src="{{ asset('storage/' . $procurement->document_path) }}" class="img-fluid"
                                    alt="Document">
                            </div>
                        @else
                            <iframe src="{{ asset('storage/' . $procurement->document_path) }}" width="100%"
